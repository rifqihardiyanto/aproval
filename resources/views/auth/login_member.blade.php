            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Silakan login untuk melakukan pengajuan!</p>
                        @if (session('status'))
                        ...
                        @endif
                        <form id="formAuthentication" class="mb-3 form-login" action="{{ url('login_member') }}"
                            method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <button class="btn btn-primary d-grid w-100" type="submit" value="submit">Sign
                                    in</button>
                            </div>
                        </form>
