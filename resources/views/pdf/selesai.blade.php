        ...
        <div class="page-header text-blue-d2">
            ...
            <div class="page-tools">
                <div class="action-buttons">
                    <a class="btn bg-white btn-light mx-1px text-95" href="{{ url('print/'. $order->id) }}" data-title="Print">
                ...
                <div class="col-12 col-lg-12">
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center text-150">
                                <img src="{{ asset('img/detail/logo.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- .row -->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div>
                                ...
                                <span class="text-600 text-110 text-blue align-middle">{{ $order->nama_pemohon }}</span>
                            </div>
                        ...
                        <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                            ...
                            <div class="text-grey-m2">
                                ...
                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                        class="text-600 text-90">Date:</span> {{ $order->created_at->format('d/m/y') }}</div>
                    ...
                    <div class="mt-4">
                        <div class="row text-600 text-white bgc-default-tp1 py-25">
                            ...
                            <div class="col-9 col-sm-5">Keperluan</div>
                        ...
                        <div class="text-95 text-secondary-d3">
                            <div class="row mb-2 mb-sm-0 py-25 bgc-default-l4">
                                ...
                                <div class="col-9 col-sm-5">{{ $order->keperluan }}</div>
                                <div class="d-none d-sm-block col-2">{{ $order->jumlah }}</div>
                                <div class="d-none d-sm-block col-2 text-95">Rp. {{ $order->harga }}</div>
                                <div class="col-2 text-secondary-d2">{{ $order->keterangan }}</div>
                            </div>
                        </div>
